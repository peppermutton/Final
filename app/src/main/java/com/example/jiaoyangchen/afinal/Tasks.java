 ...
 **/
    ...
    public class Tasks {
    public static String TAG = "final";
    public static class ProcessText extends AsyncTask<String, Void, Integer> {
        public String list = "\n" +
                ...
                "Jicama\tJohn Dory\tjuicer cheeseburger tacos\n" +
                ...
                "Saffron\tSage\tSake\n" + "fish pork beef burger pizza juice \n"+
        ...
        private String stringurl = "\"https://spoonacular-recipe-food-nutrition-v1.p.mashape.com";
        private WeakReference<MainActivity> activityref;
        private RequestQueue requestQueue;
        ProcessText(){}
        ProcessText(MainActivity upAndDown) {
            activityref = new WeakReference<>(upAndDown);
        }
        protected Integer doInBackground(String... text){
            MainActivity act = activityref.get();
            TextView show = act.findViewById(R.id.display);
            try {
                String realUrl = stringurl + "?text=" + text;
                URL url= new URL(realUrl);
                HttpURLConnection con = (HttpURLConnection) url.openConnection();
                con.setRequestProperty("X-Mashape-Key", "IfHzAq2ZUXmshfT8umIo3eyu1LIUp1CKPKzjsnv48t5emi4ZaY");
